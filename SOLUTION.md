...
The loaded DataFrames are standerdised and validated using rules. Each Dataframes is standardised using different rules as shown below.

- Customers
    - Invalid emails are dropped.
    - Emails standardised by putting them into lower case.
    - Duplicate emails are mitigigated by keeping the first occuring email and dropping the rest.

- Orders
    - A list is us used to filter for acceptable status values.
    - Invalid timestamps are dropped.
    - Timestamps are converted into UTC time.

- Order Items
    - Records with non-positive quantity or unit prices as dropped
    - Records that do not reference an order are dropped.

### Load

After the DataFrames are transformed, they are loaded into their repective Postgres tables. This is achieved by the `pyscopg` library that has a `COPY` command that enables DataFrame's to be iterativel loaded into Postgres.
...
The following views were created to analyse order metrics:
...
- Orders belonging to non existant customers
...
In this project, the following decision were made.

- Changing dimensions
    - The tables were drop and created with every run using the `init` command.
    - This was done to maintain data consistancy for demonstrative purposes.
...
2026-04-13 23:02:59,171 | INFO | order_pipeline | Initialising tables
2026-04-13 23:02:59,171 | INFO | order_pipeline | Reading config file
2026-04-13 23:02:59,211 | INFO | order_pipeline | Successful Database Connection
2026-04-13 23:02:59,239 | INFO | order_pipeline | Table Succesfuly Initialised
(venv) PS C:\sandbox\order_pipeline> python main.py run 
2026-04-13 23:03:03,937 | INFO | order_pipeline | Pipeline Started
2026-04-13 23:03:03,937 | INFO | order_pipeline | Ingesting Started
2026-04-13 23:03:03,937 | INFO | order_pipeline | Reading config file
2026-04-13 23:03:03,945 | INFO | order_pipeline | Ingestion Completed
2026-04-13 23:03:03,945 | INFO | order_pipeline | Ingestion summary: Customers = 6 Orders = 10 Order Items = 12
2026-04-13 23:03:03,945 | INFO | order_pipeline | Customer Transform Started
2026-04-13 23:03:03,946 | INFO | order_pipeline | Customer Transform Completed
2026-04-13 23:03:03,947 | INFO | order_pipeline | Customer Transform = 4
2026-04-13 23:03:03,947 | INFO | order_pipeline | Orders Transform Started
2026-04-13 23:03:03,954 | INFO | order_pipeline | Orders Transform Completed
2026-04-13 23:03:03,954 | INFO | order_pipeline | Orders Transform = 5
2026-04-13 23:03:03,954 | INFO | order_pipeline | Order Items Transform Started
2026-04-13 23:03:03,955 | INFO | order_pipeline | Order Items Transform Completed
2026-04-13 23:03:03,955 | INFO | order_pipeline | Order Items Transform = 5
2026-04-13 23:03:03,955 | INFO | order_pipeline | Reading config file
2026-04-13 23:03:03,993 | INFO | order_pipeline | Successful Database Connection
2026-04-13 23:03:03,993 | INFO | order_pipeline | customers Load Started
2026-04-13 23:03:03,998 | INFO | order_pipeline | customers Load Completed
2026-04-13 23:03:03,998 | INFO | order_pipeline | Loaded 4 customers
2026-04-13 23:03:03,999 | INFO | order_pipeline | orders Load Started
2026-04-13 23:03:04,003 | INFO | order_pipeline | orders Load Completed
2026-04-13 23:03:04,003 | INFO | order_pipeline | Loaded 5 orders
2026-04-13 23:03:04,003 | INFO | order_pipeline | order_items Load Started
2026-04-13 23:03:04,006 | INFO | order_pipeline | order_items Load Completed
2026-04-13 23:03:04,006 | INFO | order_pipeline | Loaded 5 order_items
2026-04-13 23:03:04,008 | INFO | order_pipeline | Pipeline Completed
```
